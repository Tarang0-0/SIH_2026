...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    search_input_placeholder: 'Train number or name',
    search_btn: 'Search',
    ...
    op_inspect_placeholder: 'Enter a train number',
    ...
    admin_system_node: 'Operator authentication',
  ...
  hi: {
    ...
    search_input_placeholder: 'ट्रेन नंबर या नाम',
    search_btn: 'खोजें',
    ...
    op_inspect_placeholder: 'ट्रेन नंबर दर्ज करें',
    ...
    admin_system_node: 'ऑपरेटर प्रमाणीकरण',
