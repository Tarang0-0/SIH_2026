...
## RailPulse — Real-Time Dynamic ETA Prediction System for Indian Railways
...
3. **Why RailPulse** — 3 feature cards: "AI-Powered ETA," "Explainable Delays," "Real-Time Map (2-min refresh)."
...
RailRadar.in and NTES (National Train Enquiry System) currently provide live running status primarily based on last-reported delay + static recovery margins, with a clean map-based UI. **RailPulse differentiates by:**
