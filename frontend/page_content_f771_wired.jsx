...
<div className="w-full max-w-3xl mt-8 bg-surface-elevated/95 backdrop-blur-xl border border-white/70 shadow-2xl rounded-xl p-6 sm:p-7 text-left transition-all relative z-20">
  ...
  <div className="relative flex flex-col sm:flex-row items-stretch gap-2.5">
    ...
    <button type="button" className="bg-primary hover:bg-primary-container text-on-primary px-8 py-3.5 rounded-lg text-label-caps font-label-caps uppercase font-bold tracking-wider transition-all flex items-center justify-center gap-2 shadow-md hover:shadow-lg active:scale-95 shrink-0" onClick={handleSearch}>
