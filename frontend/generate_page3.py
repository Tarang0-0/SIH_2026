...
original_btn = '<button className="cyan-btn px-8 py-4 rounded-xl font-label-md text-label-md font-bold flex items-center justify-center gap-2 whitespace-nowrap shadow-lg">'
new_btn = '<button onClick={handleSearch} className="cyan-btn px-8 py-4 rounded-xl font-label-md text-label-md font-bold flex items-center justify-center gap-2 whitespace-nowrap shadow-lg">'
jsx = jsx.replace(original_btn, new_btn)
...
jsx = jsx.replace('className="bg-[#00e5ff] h-full w-[85%] rounded-full shadow-[0_0_10px_#00e5ff]"', 'className="bg-[#00e5ff] h-full rounded-full shadow-[0_0_10px_#00e5ff]" style={{ width: `${heroData?.progress_pct || 0}%` }}')
