...
try {
    Write-Host "Starting RailTrackr backend on http://localhost:8000 ..." -ForegroundColor Cyan
    ...
    Write-Host "Starting RailTrackr frontend on http://localhost:3000 ..." -ForegroundColor Cyan
    ...
    Write-Host "" 
    Write-Host "RailTrackr is running." -ForegroundColor Green
